...
class ContentChunks {
     ...
     * For ContentChunks, the search vector is generated from the chunk's text content only.
     *
     * IMPORTANT: Do not modify this field directly - it is managed by the database.
     *
     * NOTE: ContentChunks are typically created from large documents to enable granular search.
